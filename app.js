 ...
 *
 * v1.8.122 更新:
 * - 🐛 自动化Review修复: index.html 版本徽章显示不一致 (v1.8.118→v1.8.121)
 *
 * v1.8.121 更新:
        ...
        panel.innerHTML = `
            ...
            <div style="background:rgba(0,0,0,0.2);border-radius:12px;padding:15px;margin-bottom:20px;">
                ...
                <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:10px;">
                    ...
                    <span style="background:rgba(255,165,0,0.2);padding:4px 8px;border-radius:4px;font-size:12px;">81种人设 | 172个语音关键词</span>
